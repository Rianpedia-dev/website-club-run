...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "bot",
      content: "Halo! Saya asisten Wadada Run Club. Ada yang bisa saya bantu hari ini?",
    },
  ])
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      console.error(error)
      let message = "Maaf, terjadi kesalahan. Silakan coba lagi nanti."
                ...
                <CardFooter>
                  <form onSubmit={handleSubmit} className="flex w-full items-center space-x-2">
                    <Input
                      ...
                      placeholder="Tanyakan tentang klub..."
                      disabled={isLoading}
                      className="flex-1"
                    />
